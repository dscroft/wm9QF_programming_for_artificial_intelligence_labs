...
Note that this module is written specifically for people working on Windows computers. If you are using a Mac or Linux machine, you should reference the Git Setup for Mac and Linux instructions instead.
