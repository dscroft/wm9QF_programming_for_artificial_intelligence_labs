...
Note that this module is written specifically for people working on Mac or Linux computers. If you are using a Windows machine, you should reference Git Setup for Windows instructions instead.
</div>
